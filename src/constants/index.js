...
const experiences = [
  ...
  },
  {
    ...
    company_name: "Makeen Energy A/S",
    icon: makeen,
    iconBg: "#E6DEDD",
    date: "August 2024 - December 2024",
    points: [
      "Worked on a web-app that lets Makeen technicians create various reports after a service.",
      "Creating dashboard for the managers to see the reports and access.",
      "As a solo developer, I am responsible for the whole project.",
    ],
  },
];
